...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border border-gray-200 rounded w-full max-w-4xl max-h-[85vh] overflow-x-scroll'>
                ...
                <div className='mt-4 mb-2' >
                    <p>About Doctor</p>
                    <textarea onChange={(e) => setAbout(e.target.value)} value={about} className='border border-gray-200 rounded w-full pt-2 px-4' type="text" placeholder='write about doctor' rows={5} required />
                </div>

                <button type='submit' className='bg-primary text-white px-10 py-2 mt-4 mb-4 rounded-full text-base'>Add doctor</button>
            </div>
        </form>
    )
}
